...
class ReleaseNotesTests(unittest.TestCase):
    ...
    def test_release_1_2_metadata_and_packaging_are_aligned(self):
        self.assertEqual(VERSION, "1.2.0")
        self.assertEqual(DISPLAY_VERSION, "Release 1.2")
        ...
        self.assertIn("TPS-AI-Trading-Assistant-Setup-1.2.0", installer)
        self.assertIn("ProductVersion', '1.2.0'", windows_info)
