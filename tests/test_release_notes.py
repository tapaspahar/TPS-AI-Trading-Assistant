...
class ReleaseNotesTests(unittest.TestCase):
    ...
    def test_release_1_5_7_metadata_and_packaging_are_aligned(self):
        self.assertEqual(VERSION, "1.5.7")
        self.assertEqual(DISPLAY_VERSION, "Release 1.5.7")
        self.assertEqual(RELEASE_DATE, "09-09-2026")
        ...
        self.assertIn('#define MyAppVersion "1.5.7"', installer)
        self.assertIn("TPS-AI-Trading-Assistant-Setup-1.5.7", installer)
        self.assertIn("ProductVersion', '1.5.7'", windows_info)
