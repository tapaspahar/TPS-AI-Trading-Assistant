...
class ReleaseNotesTests(unittest.TestCase):
    ...
    def test_release_1_4_5_metadata_and_packaging_are_aligned(self):
        ...
        self.assertIn('#define MyAppVersion "1.4.8"', installer)
        self.assertIn("TPS-AI-Trading-Assistant-Setup-1.4.8", installer)
        self.assertIn("ProductVersion', '1.4.8'", windows_info)
