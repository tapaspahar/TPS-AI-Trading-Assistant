...
class ReleaseNotesTests(unittest.TestCase):
    ...
    def test_release_1_3_1_metadata_and_packaging_are_aligned(self):
        self.assertEqual(VERSION, "1.3.1")
        self.assertEqual(DISPLAY_VERSION, "Release 1.3.1")
        self.assertEqual(RELEASE_DATE, "13-08-2026")
        ...
        self.assertIn('#define MyAppVersion "1.3.1"', installer)
        self.assertIn("TPS-AI-Trading-Assistant-Setup-1.3.1", installer)
        self.assertIn("ProductVersion', '1.3.1'", windows_info)
