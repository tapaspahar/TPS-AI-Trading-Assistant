...
- Added chart-first Candle Anatomy, Repeated Wick Memory and Chart + OI Confluence cards. The explanation compares the completed candle with typical range/volume, labels displacement or rejection, counts repeated upper/lower wicks and reports chart/OI alignment, conflict and broker scan time.
