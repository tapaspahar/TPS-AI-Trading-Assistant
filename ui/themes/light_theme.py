def get_light_theme():
    ...
    return """
QWidget { background: #f4f7fb; color: #13233a; font-family: "Segoe UI"; font-size: 10.5pt; }
...
QPushButton#menuButton { background: transparent; color: #46617f; border: 1px solid transparent; border-radius: 9px; padding: 11px 13px; text-align: left; font-size: 10.5pt; font-weight: 600; }
...
QLabel#cardTitle { color: #6380a0; font-size: 10.5pt; font-weight: 600; }
QLabel#cardValue { color: #102f55; font-size: 29px; font-weight: 800; }
